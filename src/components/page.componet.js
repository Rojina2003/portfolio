...
const Page = () => {
    return(
        ...
        <div className={style.Text}><span className={style.span}>Our </span>Comprehensive Digital Solutions</div>
        <div className={style.div2AllButton}>
          ...
          <div className={style.div2AllButton2}>
        ...
        <div className={style.PageScroll}>Scroll Down to Uncover Our Mobile and Web Solutions</div>
      </div>
    )
}
export default Page;